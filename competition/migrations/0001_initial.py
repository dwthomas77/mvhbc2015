    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aha_id', models.CharField(max_length=200, blank=True)),
                ('insert_date', models.DateField(auto_now_add=True, verbose_name=b'Registered On')),
                ('phone_number', localflavor.us.models.PhoneNumberField(max_length=20, null=True, blank=True)),
                ('qualification', models.CharField(max_length=200, blank=True)),
                ('bjcp_registration', models.CharField(max_length=100, blank=True)),
                ('address', models.OneToOneField(to='competition.Address')),
                ('cat_pref_no', models.ManyToManyField(related_name=b'no+', null=True, verbose_name=b'Categories Preferred Not To Judge', to='competition.Style', blank=True)),
                ('cat_pref_yes', models.ManyToManyField(related_name=b'yes+', null=True, verbose_name=b'Categories Preferred To Judge', to='competition.Style', blank=True)),
